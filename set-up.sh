...
printf "Предлагается на выбор установка одной из следующих сборок:\n"
...
printf "2. DWG-UI - сборка с веб-интерфейсов в реализации WG-Easy (есть возможность использования API)\n"
